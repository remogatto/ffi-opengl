...
@diffuseMaterial = MemoryPointer.new(:float, 4).put_array_of_float(0, [0.5, 0.5, 0.5, 1.0])
@mat_specular = MemoryPointer.new(:float, 4).put_array_of_float(0, [ 1.0, 1.0, 1.0, 1.0 ])
...
def mouse(button, state, x, y)
  diffuse = @diffuseMaterial.get_array_of_float(0, 4)
  case(button)
  ...
  @diffuseMaterial.put_array_of_float(0, diffuse)
end
